...
from ml.persona import build_persona_prompt
...
{{
  ...
  "suggestions": [
    ...
    advisor_label = f"{persona['name']} ({persona['investment_style']})" if persona else None
...
def chat(body: ChatRequest):
    ...
    session = _load_session() or {}
    persona = session.get("persona")
    persona_prefix = (build_persona_prompt(persona) + "\n\n") if persona else "You are a helpful portfolio advisor.\n\n"
